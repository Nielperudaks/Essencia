    ...
    return (
      <main className="min-h-screen bg-background">
        ...
        <div className="storefront-shell py-40 text-center">
          <h1 className="mb-5 font-serif text-5xl font-semibold">
            Product not found
          </h1>
          <Link href="/shop" className="storefront-button">
            Back to shop
          </Link>
        </div>
        <Footer />
      ...
      <div className="pt-32 pb-20">
        <div className="storefront-shell">
          ...
          <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
            <div
              data-product-reveal
              className="storefront-media aspect-[4/5] lg:sticky lg:top-28"
            >
              <Image
              ...
              {isSoldOut && (
                <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-[1px]">
                  <span
                    className="bg-foreground px-5 py-3 text-xs font-semibold uppercase text-background"
            ...
            <div className="lg:pt-10">
              <div data-product-reveal className="border-b border-border pb-8">
                ...
                <h1
                  className="mb-5 font-serif text-5xl font-semibold leading-none text-foreground sm:text-6xl lg:text-7xl"
                ...
                <div className="mb-6 flex items-center gap-3">
                  <span
                    className="mb-3 block text-xs font-extrabold uppercase text-background bg-black/80 px-1 rounded-md"
              ...
              <div data-product-reveal className="border-b border-border py-7">
                ...
                <div className="inline-flex border border-border">
                  ...
                  <span className="flex h-12 min-w-14 items-center justify-center border-x border-border font-medium">
                    {quantity}
                  </span>
                  <button
                    type="button"
              ...
              <div
                data-product-reveal
                className="grid gap-3 py-7 sm:grid-cols-2"
              >
                <button
                  type="button"
              ...
              >
                {benefits.map((benefit) => (
                  ...
                  >
                    <benefit.icon
                      className="mx-auto mb-3 size-5 text-foreground"
                      strokeWidth={1.5}
                    />
