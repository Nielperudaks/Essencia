...
const testimonials = [
  {
    ...
    name: "Alexis M.",
    location: "Cavite",
    text: "Very affordable yet the quality is top-notch. I get compliments every time I wear it. The scent is light and refreshing, perfect for everyday wear.",
    product: "Kitty Muse Perfume",
  },
  {
    id: 2,
    name: "Emilisa D.",
    location: "Las Piñas",
    text: "I like how the products are gentle on my skin but still effective. The scent is subtle and lasts all day. It's become my signature scent!",
    product: "Weekend Escape Perfume",
  },
  {
    id: 3,
    name: "Reniel P.",
    location: "Parañaque",
    text: "I have sensitive skin and was hesitant to try new products, but Essencia's skincare line has been a game-changer for me. My skin feels healthier and looks radiant.",
